...
Установлены R 4.4.1 и RStudio. ![](img/1.png)

### Шаг 2

Создан проект и локальный репозиторий. ![](img/2.png)

### Шаг 3

Создан отчет по практической работе в виде файла qmd ![](img/3.png)

### Шаг 4

Создан удаленный репозиторий на GitHub ![](img/4.png) Связываем
локальный репозиторий с удаленным
